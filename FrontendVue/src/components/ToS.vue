<template>
    <div class="container">
        <h1>Conditions générales d'utilisation du site OffresEtudiantsCH</h1>
        <h2>ARTICLE 1 : Objet</h2>
        <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site OffresEtudiantsCH et leur utilisation par « l'Utilisateur ». </p>
        ...
        <li>OffresEtudiantsCH se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</li>
        </ul>
        <h2>ARTICLE 2 : Mentions légales</h2>
        <p>L'édition du site OffresEtudiantsCH est assurée par la Société He-Arc dont le siège social est situé à Neuchâtel. </p>
        <p>Le professeur du cours est Monsieur Ulysse Rosselet. </p>
        <p>L'hébergeur du site OffresEtudiantsCH est la Société He-Arc. </p>
        ...
        <ul>
        <li>Informations d’offres de réduction valides en Suisse;</li>
        <li>Participation à la communauté;</li>
        <li>Publication d’évaluation ;</li>
        </ul>
        ...
        <p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de OffresEtudiantsCH. </p>
        ...
        <p>L'Utilisateur a la possibilité de contacter le site par messagerie électronique sur la page de contact. </p>
        ...
        <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de OffresEtudiantsCH qui n'a pas le contrôle de ces liens. </p>
        ...
        <p>La législation suisse s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux fédéraux de Suisse sont compétents. </p>
        <h2>ARTICLE 12 : Publication par l’Utilisateur</h2>
        <p>Le site permet aux membres de publier des offres publiques et des avis sur ces offres. </p>
        <p>Dans ses publications, le membre s’engage à respecter les règles de la Netiquette et les règles de droit en vigueur. </p>
        <p>Le site exerce une modération a priori sur les publications et se réserve le droit de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre. </p>
